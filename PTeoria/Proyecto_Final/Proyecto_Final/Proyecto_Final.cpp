...
glm::vec3 PosIni(16.0f, 11.0f, -16.0f); //Posicion inicial del carro
bool active;
...
glm::vec3 pointLightPositions[] = {
	...
	//Luces´para el cuarto de Bart
	glm::vec3(-9.8f,5.5f,-6.5f),//Lampara de escritorio  1
	glm::vec3(16.0f, 7.0f, 3.2f),//Lampara de noche      2
	glm::vec3(-0.1f,6.0f,-17.2f),// Lampara de tocador   3

	glm::vec3(20.0f, 4.0f, 10.0f),//Lampara de escritorio  4
	glm::vec3(19.0f, 6.0f, 1.0f),//Lampara de noche       5
	glm::vec3(20.0f, 7.0f, 1.0f),// Lampara de tocador    6
...
int main()
{
	...
	Model casa((char*)"Models/casaCompleta.obj");//Casa por fuera
	Model cuarto((char*)"Models/proyectFinal.obj");//cuartos modelados
	...
	Model sillaTocador((char*)"Models/silla_tocador.obj");//silla animada del cuarto de Lisa
	Model principal((char*)"Models/principal.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Point light 6
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].position"), pointLightPositions[5].x, pointLightPositions[5].y, pointLightPositions[5].z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].ambient"), 0.05f, 0.05f, 0.05f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].diffuse"), 1.0f, 0.0f, 1.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].specular"), 1.0f, 0.0f, 1.0f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[3].constant"), 1.0f);
		...
		model = glm::translate(model, glm::vec3(17.0, 0.95, 1.0));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		cuarto.Draw(lightingShader);

		//Modelo de la puerta de Bart
		model = glm::translate(tmp, glm::vec3(9.88f, 4.8f, -18.9f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		...
		//Modelo de la puerta de Lisa
		model = glm::translate(tmp, glm::vec3(38.8f, 4.8f, -18.9f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		//Se suma la variable puerta_rot para darle movimiento a la puerta
		model = glm::rotate(model, glm::radians(puerta_rot + 180.0f), glm::vec3(0.0f, 1.0f, 0.0));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Modelo de la ventana de Bart
		model = glm::translate(tmp, glm::vec3(10.0f, 9.2f, 9.45f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		...
		//Modelo de la ventana de Lisa
		model = glm::translate(tmp, glm::vec3(39.0f, 9.2f, 9.45f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		//Se suma la variable ventana_rot para darle movimiento a la ventana
		model = glm::rotate(model, glm::radians(180.0f + ventana_rot), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Modelo del avión
		model = glm::translate(tmp,glm::vec3(16.0f, 9.2f, -12.0f));
		...
		model = glm::translate(tmp, glm::vec3(-9.78f + cajon_mov, 1.075f, -3.6f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		...
		//Modelo del reloj
		model = glm::translate(tmp, glm::vec3(15.0f, 4.8f, -14.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		...
		//Modelo silla del tocador
		model = glm::translate(tmp, glm::vec3(42.0f+ silla_mov, 1.0f, -4.8f));
		model = glm::scale(model, glm::vec3(2.5f, 2.5f, 2.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		sillaTocador.Draw(lightingShader);

		//Modelo de la casa
		model = glm::translate(model, glm::vec3(-14.5f, -1.0f, 5.0f));
